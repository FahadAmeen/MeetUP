...
public class ListOnline extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    //Location
    private static final int MY_PERISSION_REQUEST_CODE = 7171;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("FaHD Presence System");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        switch (requestCode){
            case MY_PERISSION_REQUEST_CODE:
    ...
    private void displayLocation() {
        ...
        if(mLastLocation!=null){
           ...
           locations.setValue(new Tracking(FirebaseAuth.getInstance().getCurrentUser().getEmail(),
